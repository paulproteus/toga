...
R__integer = JavaClass("android/R$integer")
...
ValueAnimator = JavaClass("android/animation/ValueAnimator")
ValueCallback = JavaInterface("android/webkit/ValueCallback")
VelocityTracker = JavaClass("android/view/VelocityTracker")
ViewConfiguration = JavaClass("android/view/ViewConfiguration")
